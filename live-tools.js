...
es:['Calidad de los datos','Reservas declaradas muy bajas: un intercambio puede fallar o alterar mucho el precio.','Faltan datos de algunas reservas. El total puede no estar disponible.','Las reservas declaradas no garantizan un precio de ejecución.','Exportar pools (CSV)','Precios observados, no precios de venta del proyecto. Una transferencia no es necesariamente una compra.','Última consulta','Sin datos para exportar'],
it:['Qualità dei dati','Riserve dichiarate molto basse: uno scambio può fallire o avere un forte impatto sul prezzo.','Mancano alcuni dati sulle riserve. Il totale può non essere disponibile.','Le riserve dichiarate non garantiscono un prezzo di esecuzione.','Esporta pool (CSV)','Prezzi osservati, non prezzi di vendita del progetto. Un trasferimento non è necessariamente un acquisto.','Ultima verifica','Nessun dato da esportare'],
de:['Datenqualität','Sehr geringe gemeldete Reserven: Ein Tausch kann scheitern oder den Preis stark beeinflussen.','Einige Reserveangaben fehlen. Summen können nicht verfügbar sein.','Gemeldete Reserven garantieren keinen Ausführungspreis.','Pools exportieren (CSV)','Beobachtete Preise, keine Verkaufspreise des Projekts. Ein Transfer ist nicht unbedingt ein Kauf.','Zuletzt geprüft','Keine Daten zum Export'],
ar:['جودة البيانات','الاحتياطيات المعلنة منخفضة جداً: قد يتعذر التبادل أو يتأثر السعر بشدة.','بعض بيانات الاحتياطيات مفقودة. قد لا يتوفر الإجمالي.','الاحتياطيات المعلنة لا تضمن سعر التنفيذ.','تصدير المجمعات (CSV)','أسعار مرصودة وليست أسعار بيع المشروع. تحويل العملة ليس بالضرورة عملية شراء.','آخر تحقق','لا توجد بيانات للتصدير'],
